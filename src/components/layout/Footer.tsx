...
const Footer: React.FC = () => {
  ...
  return (
    <footer className="bg-gradient-to-r from-black via-gray-900 to-red-900 border-t border-gray-800 relative overflow-hidden">
      ...
      <div className="absolute inset-0 bg-gradient-to-br from-black/80 via-red-900/20 to-black/90"></div>
        ...
        <div className="grid grid-cols-1 gap-8">
          ...
          <div className="col-span-1">
            ...
            <p className="text-gray-300 mb-6 max-w-md text-sm leading-relaxed">
              Intelligent task management powered by AI. Boost your productivity with smart suggestions and automated workflows.
            </p>
            <div className="flex space-x-4">
              <a href="#" className="w-10 h-10 bg-gray-800/50 hover:bg-gray-700/50 rounded-lg flex items-center justify-center text-gray-400 hover:text-blue-500 transition-all duration-300 group">
          ...
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center space-y-4 sm:space-y-0">
            <div className="flex items-center space-x-2">
              ...
              <p className="text-gray-400 text-sm">
                © {currentYear} TaskSmart. All rights reserved.
              </p>
            </div>
            <div className="flex flex-col sm:flex-row space-y-2 sm:space-y-0 sm:space-x-8 text-center sm:text-left">
              <a href="#" className="text-gray-400 hover:text-orange-400 text-sm transition-colors duration-200 hover:underline">
                Privacy Policy
              </a>
              <a href="#" className="text-gray-400 hover:text-orange-400 text-sm transition-colors duration-200 hover:underline">
                Terms of Service
